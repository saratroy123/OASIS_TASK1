...
public class NumberGuessing {
    ...
    static void playGame() {
        ...
        // Loop until the user correctly guesses the number or reaches the maximum
        // number of guesses
        while (true) {
            usersGuess = scf.nextInt(); // Read the user's guess
            ...
            // If the user's guess is too high, prompt them to guess again and provide a
            // hint
